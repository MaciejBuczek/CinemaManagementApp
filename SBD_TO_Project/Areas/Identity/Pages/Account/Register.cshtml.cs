...
namespace SBD_TO_Project.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (!await _roleManager.RoleExistsAsync(WebConstants.ManagerRole))
                await _roleManager.CreateAsync(new IdentityRole(WebConstants.ManagerRole));
            if (!await _roleManager.RoleExistsAsync(WebConstants.EmployeeRole))
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if ((_db as IdentityDbContext).Users.Count() == 0)
                    isFirstAccount = true;
